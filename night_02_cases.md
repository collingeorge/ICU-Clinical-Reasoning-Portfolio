# CTICU/ICU Overnight Attending Briefing
## 8-Patient Comprehensive Summary

**Date:** December 07–08, 2025  
**Prepared by:** Collin (ICU Night Coverage)

---

## Patient 1 — Post-CABG (POD0), Hypotension, Vasoplegia vs Pump Failure

**Status:** Hypotension MAP 58 on norepi 0.12 + vaso 0.03, CI 2.0, lactate 3.1 ↑, temp 35.5°C, chest tube 120 mL/hr.

**Assessment:** Mixed vasoplegia vs early LV dysfunction. Hypothermia and mild ongoing bleeding contributing. Perfusion borderline.
...
## Patient 2 — VA-ECMO for Post-MI Cardiogenic Shock

**Status:** ECMO flow 3.8 L/min, lactate 5.2 ↓ from 8, MAP 65, UOP low (10–15 mL/hr), CVP 14, limb ischemia risk.

**Assessment:** ECMO improving perfusion; AKI with venous congestion; possible limb ischemia.
...
- Hourly Doppler to left leg; consider distal perfusion catheter if perfusion worsens
- Lung-rest ventilation; FiO₂ titration
...
## Patient 3 — HeartMate 3 LVAD (POD1), Borderline RV Function

**Status:** Speed 5100 / Flow 4.6 / PI 2.1, MAP 70 on NE 0.04, CVP 10, lactate 1.8.

**Assessment:** Early LVAD physiology; PI borderline; need to balance preload and avoid RV strain.
...
**Goals AM:** Off pressors, extubated or ready, PI > 2.5–3, CVP 8–12, stable flows.

---

## Patient 4 — ARDS from Pneumonia, Hypoxemia (PF ≈ 87)

**Status:** PRVC, FiO₂ 70%, PEEP 12 (now increasing), Pplat 28, DP 16, MAP 68 on NE 0.06.

**Assessment:** Moderate–severe ARDS; meets criteria for proning; dyssynchrony risk.

**Plan Overnight:**
- Increase PEEP to 14–18 using high-PEEP ARDSNet table
...
## Patient 5 — POD2 Type A Dissection Repair, Hypertension + AKI

**Status:** SBP 152, HR 80, CVP 4, UOP 20–25 mL/hr, Cr 2.1.

**Assessment:** Dangerous postoperative hypertension; likely prerenal AKI; risk of renal malperfusion.

**Plan Overnight:**
- 250–500 mL crystalloid to CVP 6–8
- Continue esmolol (HR < 80)
...
## Patient 6 — Bilateral Lung Transplant (POD0–1), Reperfusion Injury / PGD Grade 2–3

**Status:** FiO₂ 60%, PEEP 8 → worsening compliance (DP 22), ABG 7.28/52/66, +2.5 L since OR.

**Assessment:** Early PGD; high DP; volume overload; vulnerable graft.
...
- Maintain MAP ≥ 65 with norepi rather than fluids
- Continue basiliximab, tacrolimus, steroids
...
## Patient 7 — Septic Shock, Open Abdomen, Refractory Hypotension

**Status:** MAP 54 on NE 0.18, lactate 6.5 rising, CVP 14, UOP 5–10 mL/hr.

**Assessment:** Severe distributive shock + venous congestion; high risk of multi-organ failure; abdominal compartment physiology possible.

**Plan Overnight:**
- Add vasopressin 0.03 U/min immediately
...
## Patient 8 — SAH (Fisher 3, coil POD1) + Takotsubo Cardiomyopathy

**Status:** ICP 14, CPP 66, MAP 70 on low-dose NE; EF 30%; Na 150; risk of vasospasm (PBD2).
...
- Maintain Na 145–155 with 3% drip 30 mL/hr; BMP q6h
- Hourly neuro exams; maintain normal capnia
- Daily TCDs; CTA if exam worsens
- Delay extubation 24–48 hr until neuro-stable + cardiac-stable
...
## Overnight Global Themes Across the Unit

**Hemodynamics:** 4 patients on vasopressors; 1 on VA-ECMO; 1 LVAD.

**Ventilation:** 3 patients with impaired compliance or ARDS physiology; proning and paralysis active.

**Renal:** 2 patients likely requiring or already on CRRT (ECMO + septic shock).

**Neuro:** 1 high-risk SAH requiring hourly exams and strict CPP control.
